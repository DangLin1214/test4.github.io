...
```{r message = FALSE, warning = FALSE}
Baseline_expo_lmr_cat_results <- read_csv("./Baseline_expo_lmr_cat.csv")
...
<img src="./cumhaz_expo_lmr_cat_nafld.png" style="width:180%;">
...
<img src="./cumhaz_expo_lmr_cat_cirrho.png" style="width:180%;">
...
<img src="./cumhaz_expo_sii_cat_nafld.png" style="width:180%;">
...
<img src="./cumhaz_expo_sii_cat_cirrho.png" style="width:180%;">
...
#### Cumulative Hazard Plot for SII Exposure in NAFLD Outcome
<img src="./cumhaz_expo_npar_cat_nafld.png" style="width:180%;">
...
<img src="./cumhaz_expo_npar_cat_cirrho.png" style="width:180%;">
...
```{r message = FALSE, warning = FALSE}
nafld_results <- read_csv("./Main_cox_nafld.csv")
...
```{r message = FALSE, warning = FALSE}
cirrhosis_results <- read_csv("./Main_cox_cirrhosis.csv")
...
```{r message = FALSE, warning = FALSE}
Baseline_expo_sii_cat_results <- read_csv("./Baseline_expo_sii_cat.csv")
...
```{r message = FALSE, warning = FALSE}
Baseline_expo_npar_cat_results <- read_csv("./Baseline_expo_npar_cat.csv")
...
```{r message = FALSE, warning = FALSE}
Baseline_expo_nps_cat_results <- read_csv("./Baseline_expo_nps_cat.csv")
